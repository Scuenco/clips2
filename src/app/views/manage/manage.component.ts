...
export class ManageComponent implements OnInit {
  ...
  videoOrder = signal('1'); //descending order
  clips = signal<IClip[]>([]);
  ...
  sort($event: Event) {
    ...
    // this.router.navigateByUrl(`/manage?sort=${value}`); option 1
    this.router.navigate([], {// option 2: query parameters are added to the path
